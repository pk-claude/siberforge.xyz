...
(function () {
  ...
  const PAGES = {
    equity: {
      ...
      groups: [
        ...
        { label: 'Single-name', links: [
          { id: 'single-name-hub', label: 'Single-name research', href: '/core/single-name/', meta: '38 names live: valuation lab, EDGAR fundamentals, peer comps, ETF variants' },
    ...
    'equity:single': {
      ...
      groups: [
        { links: [
          { id: 'single-name-hub', label: 'All names',        href: '/core/single-name/',       meta: 'Hub - all 38 names live' },
          ...
          { id: 'sn-tsla',  label: 'Tesla (TSLA)',     href: '/core/single-name/tsla/',  meta: 'AI narrative vs 1.4% op margin' },
          { id: 'sn-orcl',  label: 'Oracle (ORCL)',    href: '/core/single-name/orcl/',  meta: '$638B RPO, debt-funded OCI' },
          { id: 'sn-ibm',   label: 'IBM (IBM)',        href: '/core/single-name/ibm/',   meta: 'Post-crash value or trap' },
          { id: 'sn-cat',   label: 'Caterpillar (CAT)', href: '/core/single-name/cat/',  meta: '$72B backlog, data-center power' },
          { id: 'sn-cvx',   label: 'Chevron (CVX)',    href: '/core/single-name/cvx/',   meta: 'Record production, Hess synergies' },
          { id: 'sn-vst',   label: 'Vistra (VST)',     href: '/core/single-name/vst/',   meta: 'Data-center power PPAs' },
          { id: 'sn-be',    label: 'Bloom Energy (BE)', href: '/core/single-name/be/',   meta: 'Fuel cells for AI datacenters' },
          { id: 'sn-sofi',  label: 'SoFi (SOFI)',      href: '/core/single-name/sofi/',  meta: '43% growth bank at 30x forward' },
          { id: 'sn-rivn',  label: 'Rivian (RIVN)',    href: '/core/single-name/rivn/',  meta: 'R2 ramp, VW bridge' },
          { id: 'sn-nbis',  label: 'Nebius (NBIS)',    href: '/core/single-name/nbis/',  meta: 'The profitable neocloud' },
          { id: 'sn-spcx',  label: 'SpaceX (SPCX)',    href: '/core/single-name/spcx/',  meta: 'Largest IPO in history' },
          { id: 'sn-ionq',  label: 'IonQ (IONQ)',      href: '/core/single-name/ionq/',  meta: 'Trapped-ion quantum, $2B cash' },
          { id: 'sn-qbts',  label: 'D-Wave (QBTS)',    href: '/core/single-name/qbts/',  meta: 'Annealing bookings vs revenue' },
          { id: 'sn-rgti',  label: 'Rigetti (RGTI)',   href: '/core/single-name/rgti/',  meta: 'Superconducting, Cepheus roadmap' },
          { id: 'sn-qs',    label: 'QuantumScape (QS)', href: '/core/single-name/qs/',   meta: 'Solid-state licensing model' },
          { id: 'sn-hovr',  label: 'Horizon Aircraft (HOVR)', href: '/core/single-name/hovr/', meta: 'Fan-in-wing eVTOL micro-cap' },
          { id: 'sn-mrln',  label: 'Merlin (MRLN)',    href: '/core/single-name/mrln/',  meta: 'Autonomous flight, USSOCOM prime' },
          { id: 'sn-xlk',   label: 'Tech SPDR (XLK)',  href: '/core/single-name/xlk/',   meta: 'ETF - capped tech sector fund' },
          { id: 'sn-ewy',   label: 'South Korea (EWY)', href: '/core/single-name/ewy/',  meta: 'ETF - memory supercycle country fund' },
        ]},
      ],
    },
